					...
					<form:form action ="add-product" method="post" enctype="multipart/form-data" modelAttribute="product">
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Tên
								sản phẩm</label> <form:input path="productName" type="text" class="form-control"
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Ảnh
								mặt trước</label> <input type="file" name="anhtruoc" class="form-control"
								id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Ảnh
								mặt sau</label> <input type="file" name="anhsau" class="form-control"
								id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Giá
								tiền</label> <form:input path="price" type="number" class="form-control"
								id="exampleInputEmail1"  aria-describedby="emailHelp"/>
						</div>
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Số
								lượng</label> <form:input path="quantity" type="number" class="form-control"
								id="exampleInputEmail1" aria-describedby="emailHelp"/>
						</div>
